...
qaset_file = 'test_set/id_cof/chunk_sz_full_article/qaset_full_article.json'
all_chunk_file = 'test_set/id_cof/chunk_sz_full_article/all_chunks_by_article.json'
...
chunk_range = {'Luật Doanh nghiệp 2020': (0, 217),
 'Nghị định 16/2023/NĐ-CP': (218, 233),
 'Nghị định 23/2022/NĐ-CP': (234, 288),
 'Nghị định 122/2021/NĐ-CP': (289, 370),
 'Nghị định 47/2021/NĐ-CP': (371, 405),
 'Nghị định 01/2021/NĐ-CP': (406, 506),
 'Nghị định 153/2020/NĐ-CP': (507, 551)}
...
def match_references_and_assign_chunk_ranges(row):
    ...
    for ref in references:
        ...
        if document in chunk_range:
            ...
            pattern = fr'\b{re.escape(article)}\b'
            matched_rows = [d for d in data if re.search(pattern, d['title']) and chunk_ids_range[0] <= d['id'] <= chunk_ids_range[1]]
